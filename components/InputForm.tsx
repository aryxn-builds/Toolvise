...
export function InputForm() {
  return (
    <Card className="w-full max-w-2xl border-white/10 bg-[#1A1A1A]/80 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_30px_80px_rgba(0,0,0,0.65)]">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className="min-h-28 resize-y border-white/10 bg-black/40 text-white placeholder:text-white/35 focus-visible:ring-[#F97316]/40"
          />
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Select>
              <SelectTrigger className="border-white/10 bg-black/40 text-white focus:ring-[#F97316]/40">
        ...
        <div className="flex items-center justify-end gap-3">
          <Button
            type="button"
            className="h-11 w-full bg-[#F97316] text-white shadow-[0_12px_40px_rgba(249,115,22,0.25)] hover:bg-[#EA6C0A] sm:w-auto"
          >
            Find My Stack
          </Button>
        </div>
