    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className={cn(
          ...
          isFollowing
            ? "border border-[#FFD896] bg-white text-[#111827] hover:bg-red-50 hover:text-red-600 hover:border-red-200"
            : "bg-[#F97316] text-white hover:bg-[#EA6C0A] shadow-sm shadow-amber-500/30"
        )}
      >
