          ...
          {user ? (
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-[#FFD896] bg-white px-2 py-1.5 transition-all hover:bg-[#fff1d6]"
              >
                {profile?.avatar_url ? (
                  <img
                ...
                <ChevronDown
                  className={cn(
                    "h-3.5 w-3.5 text-[#111827]/50 transition-transform",
              ...
              {/* Dropdown */}
              {dropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 rounded-xl border border-[#FFD896] bg-white shadow-lg py-1 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="px-4 py-3 border-b border-[#FFD896]/50">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-3 px-4 py-2.5 text-sm text-[#111827]/70 hover:bg-[#fff1d6] hover:text-[#111827] transition-colors"
                  >
                  ...
                  <div className="border-t border-[#FFD896]/50 mt-1 pt-1">
                    <button
            ...
            <>
              <Link
                ...
                className={cn(
                  ...
                  "border-[#FFD896] bg-transparent text-[#111827]/70 hover:bg-white hover:text-[#111827] hidden sm:inline-flex"
                )}
              >
                Sign In
              </Link>
              <Link
                ...
                className={cn(
                  ...
                  "bg-[#F97316] text-white hover:bg-[#EA6C0A] shadow-sm"
                )}
              >
                Sign Up
              </Link>
