        ...
        <div className="card-3d p-8 shadow-medium rounded-3xl">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="username" className="text-[#E6EDF3]/80">
                Username
              </Label>
              <div className="relative">
                ...
                <div className="absolute right-3 top-3">
                  {usernameStatus === "checking" && (
                    <Loader2 className="h-4 w-4 animate-spin text-[#E6EDF3]/30" />
                  )}
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-[#E6EDF3]/40">Minimum 8 characters</p>
            </div>
