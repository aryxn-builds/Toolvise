      ...
      <main className="mx-auto max-w-5xl px-4 pt-32 pb-24 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-20 md:gap-32">
          ...
          <section className="animate-in slide-in-from-bottom-6 fade-in duration-700 delay-500 fill-mode-both">
            <h2 className="text-3xl font-bold text-center text-white mb-12">What Toolvise does</h2>
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-sm transition-colors hover:bg-white/[0.04]">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">🌍 Community Stacks</h3>
                <p className="text-white/60">See what others are building worldwide</p>
              </div>

              <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-sm transition-colors hover:bg-white/[0.04]">
                <Zap className="h-8 w-8 text-amber-400 mb-5" />
                <h3 className="text-xl font-semibold text-white mb-3">⚡ Instant & Free</h3>
                <p className="text-white/60">No signup needed. Results in seconds.</p>
              </div>
          ...
          <section className="rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-10 text-center sm:p-16 animate-in slide-in-from-bottom-6 fade-in duration-700 delay-700 fill-mode-both">
            <h2 className="text-3xl font-bold text-white mb-6">Built by a student, for builders</h2>
