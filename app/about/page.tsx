    ...
    <div className="min-h-dvh bg-white bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(232,162,78,0.12)_0%,transparent_70%)] font-sans text-foreground/90 selection:bg-[#FBE4D8]/30">
      ...
      <main className="mx-auto max-w-5xl px-4 pt-24 pb-24 sm:px-6 lg:px-8">
        ...
        <section className="mb-24 text-center mt-12 animate-in slide-in-from-bottom-6 fade-in duration-300">
          <h1 className="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-plum-500 to-plum-400 sm:text-6xl mb-6">
            About Toolvise
          </h1>
        ...
        <div className="grid gap-20 md:gap-32">
          ...
          <section className="animate-in slide-in-from-bottom-6 fade-in duration-300 delay-75 fill-mode-both">
            <div className="max-w-3xl">
              <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
                <Code2 className="h-6 w-6 text-[#854F6C]" /> What is Toolvise?
              </h2>
          ...
          <section className="animate-in slide-in-from-bottom-6 fade-in duration-300 delay-100 fill-mode-both">
            <div className="max-w-3xl ml-auto text-left md:text-right">
              <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3 justify-start md:justify-end">
                <Users className="h-6 w-6 text-[#854F6C]" /> Why we built this
              </h2>
              <p className="text-lg text-foreground/70 leading-relaxed">
          ...
          <section className="animate-in slide-in-from-bottom-6 fade-in duration-300 delay-75 fill-mode-both">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border bg-white p-8 backdrop-blur-sm transition-colors hover:bg-white">
                <Target className="h-8 w-8 text-plum- mb-5" />
              ...
              <div className="rounded-2xl border border-[#522B5B]/20 bg-[#FBE4D8]/5 p-8 backdrop-blur-sm shadow-[0_0_30px_-10px_rgba(168,85,247,0.15)] transition-colors hover:bg-[#FBE4D8]/10">
                <Bot className="h-8 w-8 text-[#854F6C] mb-5" />
              ...
              <div className="rounded-2xl border border-border bg-white p-8 backdrop-blur-sm transition-colors hover:bg-white">
                <Zap className="h-8 w-8 text-[#854F6C] mb-5" />
          ...
          <section className="grid gap-6 sm:grid-cols-3 text-center border-t border-border pt-16 mt-8 animate-in slide-in-from-bottom-6 fade-in duration-300 delay-100 fill-mode-both">
            <div>
              <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-plum-500 to-indigo-400 mb-2">
                {statsCount}
              </div>
            ...
            <div>
              <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-plum- to-plum-400 mb-2">AI</div>
