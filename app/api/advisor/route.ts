...
Based on this, recommend me the perfect tech stack.${vibeAddon}`;
    ...
    try {
      ...
      await logApiUsage("gemini", "gemini-2.5-flash", durationMs, true, false);
      ...
      await logApiUsage("gemini", "gemini-2.5-flash", geminiDuration, false, false, (geminiErr as Error).message);
